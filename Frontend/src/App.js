import React, { useEffect } from 'react'; // Add useEffect import from React
import { BrowserRouter as Router, Routes, Route, useLocation } from 'react-router-dom'; // Add useLocation import from react-router-dom
...
const PageTracker = () => {
    ...
    useEffect(() => {
        logPageView(); // Log page view on location change
    }, [location]);
